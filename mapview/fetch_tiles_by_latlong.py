...
LAT_MIN = float(input("Enter latitude minimum (south): "))
LAT_MAX = float(input("Enter latitude maximum (north): "))
if LAT_MIN > LAT_MAX:
    print ("Invalid input, min must be less than max.")
    exit
LON_MIN = float(input("Enter longitude minimum (west): "))
LON_MAX = float(input("Enter longitude maximum (east): "))
if LON_MIN > LON_MAX:
    print ("Invalid input, min must be less than max.")
    exit
ZOOM_MIN = int(input("Enter zoom minimum (high level): "))
ZOOM_MAX = int(input("Enter zoom maximum (zoomed in): "))
